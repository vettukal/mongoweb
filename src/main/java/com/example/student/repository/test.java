...
public class test {
	...
	//private static final String LOCATION_SERVER = "http://http://52.35.159.233:80";
...
//		}
		...
		List<String> subdone =  quizControl.getDone2("vince@gmail.com");
		for (String siter : subdone) {
			System.out.println(siter);
		}
